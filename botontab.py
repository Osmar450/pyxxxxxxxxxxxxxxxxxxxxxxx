...
# Función para simular la tecla Tab
def simulate_tab():
    pygame.event.post(pygame.event.Event(KEYDOWN, key=K_TAB))

# Estado del juego
game_state = GameState()

# Botón para reiniciar el juego
restart_button = CircularButton(WIDTH - 100, HEIGHT - 100, 40, BLUE_LIGHT, "B", pygame.font.SysFont(None, 40))
...
while running:
    ...
    for event in pygame.event.get():
        if event.type == QUIT:
            ...
            if game_state.menu:
                # Verificar clic en el botón para reiniciar el juego
    ...
    if game_state.menu:
        ...
        # Dibujar el botón circular para reiniciar el juego
